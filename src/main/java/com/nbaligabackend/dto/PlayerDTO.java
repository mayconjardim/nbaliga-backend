...
public class PlayerDTO implements Serializable {
	...
	public PlayerDTO(Long id, String firstname, String lastname, String name, Integer height, Integer weight,
			Integer age, Integer birthmonth, Integer birthday, Integer birthyear, String currentleague,
			Integer currentleagueid, String currentteam, Integer currentteamid, String contractteam,
			Integer conractteamid, String dlgteam, Integer dlgteamid, String injury, Integer timeinjured,
			Boolean inactive, Integer positionnumber, Integer experience, String college, String city, String state,
			Integer greed, Integer happiness, Integer loyalty, Integer winner, String insidescoring, String jumpshot,
			String freethrowshot, String threepointshot, String handling, String passing, String offensiverebounding,
	...
	public PlayerDTO(Player entity) {
		...
		this.conractteamid = entity.getContractteamid();
		this.dlgteam = entity.getDlgteam();
		this.dlgteamid = entity.getDlgteamid();
		...
		this.contract6 = entity.getContract6();
		this.contract7 = entity.getContract7();
		this.contract8 = entity.getContract8();
		this.optiontype1 = entity.getOptiontype1();
		this.optiontype2 = entity.getOptiontype2();
		this.optiontype3 = entity.getOptiontype3();
		this.optiontype4 = entity.getOptiontype4();
		this.optiontype5 = entity.getOptiontype5();
		this.optiontype6 = entity.getOptiontype6();
